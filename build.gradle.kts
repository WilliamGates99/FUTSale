...
plugins {
    id("com.android.application") version "7.4.0" apply false // Android Gradle Plugin Version
    id("com.android.library") version "7.4.0" apply false // Android Gradle Plugin Version

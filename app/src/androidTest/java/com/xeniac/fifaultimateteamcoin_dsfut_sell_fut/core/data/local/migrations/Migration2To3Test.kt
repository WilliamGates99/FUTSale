...
class Migration2To3Test {
    ...
    @Test
    fun migration2To3_containsCorrectData() = runTest {
        ...
        migrationHelper.createDatabase(
            ...
            execSQL(
                ...
                'pc', -- platform
                $currentTimeInMs, -- pick_up_time_in_seconds
                1 -- id
                )
                """.trimIndent()
            )
        ...
        db.query(query = "SELECT * FROM players").apply {
            ...
            assertThat(getInt(getColumnIndex("pick_up_time_in_seconds"))).isEqualTo(currentTimeInMs / 1000)
        }
    }
}